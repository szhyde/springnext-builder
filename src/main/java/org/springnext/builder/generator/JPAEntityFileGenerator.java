 ...
 * @author 李程鹏
 */
public class JPAEntityFileGenerator {
    /**
     * 表格集合
     */
     ...
     * @param tables 表格集合
     */
    public JPAEntityFileGenerator(List<Table> tables) {
        // 赋值
        this.tables = tables;
    }
    ...
    private void generatePO(Table table,ProjectInfo projectInfo) throws Exception {
        // 获取生成的实体类
        Class entity = new POGenerator(table,projectInfo).generate();
        
        String filePath = projectInfo.getAbsoluteModelNamePackagePath()+"entity"+File.separator;
        // 根据实体类内容生成文件
