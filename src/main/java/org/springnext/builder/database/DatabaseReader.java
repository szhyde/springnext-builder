...
public class DatabaseReader {
     ...
     * @param database 数据库
     */
    public DatabaseReader(String jarFilePath,String driverClass,String url,String username, String password, String database) throws Exception {
        // 将数据库名赋值给属性
        this.database = database;
        // 获取数据库连接
        connection = ConnectionFactory.getInstance().getConnection(jarFilePath,driverClass,url,username, password, database);
        // 获取数据库元数据
